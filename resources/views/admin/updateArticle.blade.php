                    ...
                    <td width="100%" >
                        <center>
                              <div style="margin:15px 0 0 0">
                                  ...
                                  @endif
                                  <hr>
                                  <form method ="POST" action="{{route('saveArticle', $article->id)}}" enctype="multipart/form-data">  
                                  @csrf
                                      <input class="inputBlue" type="text" name="title" placeholder="Article Title" value="{{$article->title}}" required>
                                      <textarea class="inputBlue" type="text" style="height: 80px;padding-top: 15px;" name="body" placeholder="Article Body" required>{{$article->body}}</textarea>
                                      
                                      <div class="file-input">
                                      <input type="file" id="file" class="file" name="photo" value="{{$article->photo}}">
                                      <label for="file">
                                        Select Image
                                        <p class="file-name"></p>
                                      </label>
                                    ...
                                    <br>
                                     <hr>
                                     <input type="submit" class="btnBlue" value="Edit">   
                                 </form> 
                            </div>
                       </center>                         
                    </td>
